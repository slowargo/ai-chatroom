...
const messages: Record<Locale, Dict> = {
  'zh-CN': {
    ...
    'admin.pw.envPinned': 'owner 密码由环境变量设定，无法在此修改。',
    ...
    'admin.settings.accessCannotDisable': '无法关闭：服务绑定在非本地地址且未设 owner 密码，关闭将导致公网无认证暴露。',
  ...
  en: {
    ...
    'owner.logout': 'Logout',
    'owner.loggedOut': 'You have been logged out',
    'admin.title': 'Admin',
    'admin.pw.title': 'Change owner password',
    ...
    'admin.pw.envPinned': 'The owner password is set via an environment variable and cannot be changed here.',
    ...
    'admin.settings.accessCannotDisable': "Can't disable: the server is bound to a non-loopback address with no owner password, which would leave it publicly unauthenticated.",
  ...
  'zh-TW': {
    ...
    'persona.create': '新建人設',
    'nav.admin': '管理設定',
    'owner.login': 'Owner 登入',
    'owner.logout': '登出',
    'owner.loggedOut': '已登出',
    'admin.title': '管理設定',
    'admin.pw.title': '修改 owner 密碼',
    'admin.pw.old': '目前密碼',
    'admin.pw.new': '新密碼',
    ...
    'admin.pw.envPinned': 'owner 密碼由環境變數設定，無法在此修改。',
    ...
    'admin.settings.accessCannotDisable': '無法關閉：服務綁定在非本機位址且未設 owner 密碼，關閉將導致公網無認證暴露。',
